...
namespace EDBOT_signup.Controllers
{
    public class UsersController : Controller
    {
        private readonly ApplicationUser _context;

        public UsersController(ApplicationUser context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("UserId,Name,ClassName,Email")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserId,Name,ClassName,Email")] User user)
        {
            if (id != user.UserId)
            {
                return NotFound();
